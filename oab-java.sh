...
function usage() {
    ...
    echo
    echo "    cd ~/"
    echo "    wget https://github.com/sendflexi/oab-java6/raw/${VER}/`basename ${0}` -O `basename ${0}`"
...
# Update apt cache
echo "deb file://${WORK_PATH}/deb / #Local Java - https://github.com/sendflexi/oab-java6" > /etc/apt/sources.list.d/oab.list
apt_update
